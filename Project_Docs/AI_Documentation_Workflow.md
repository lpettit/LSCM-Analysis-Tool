...
This document contains the project documentation policy for AI-assisted work in the LSCM Analysis Tool repository. The root `AGENTS.md` file points here so startup instructions stay concise while the full documentation rules remain version-controlled and easy to reference.

...
uicontrol(panel, 'Style', 'pushbutton', 'String', 'Clear', ...
    ...
    'Callback', @onClear);
uicontrol(panel, 'Style', 'pushbutton', 'String', 'Done', ...
...
tableBox = uitable(panel, 'Units', 'normalized', 'Position', [0.06 0.20 0.88 0.25], ...
    'ColumnName', {'ROI', 'Type', 'Rp (um)', 'Rv (um)', 'Rz (um)'}, ...
    'ColumnEditable', false(1, 5), ...
    'ColumnWidth', {40, 65, 58, 58, 58}, ...
    'RowName', []);
...
if isgraphics(fig)
        ...
        switch modeName
            ...
            case 'area'
                setStatus({ ...
                    ...
                    'First click centers the preview. Second click places the ROI.'});
            otherwise
                setStatus({'Idle.', 'Choose a placement mode or click Done.'});
        end
    end
    ...
    function onCloseRequest(~, ~)
        ...
        choice = questdlg( ...
            'Close without clicking Done? Unsaved legacy roughness results will be discarded.', ...
